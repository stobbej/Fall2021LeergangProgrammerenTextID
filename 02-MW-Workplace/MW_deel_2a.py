...
tm = TextModel()
tm.read_text_from_file("""C:\\Users\\marli\\SynologyDrive\\Marlies Werk\\Studies en opleidingen\\IT Academy - Leergang Programmeren\\TextID\\Fall2021LeergangProgrammerenTextID\\Tekst-bestanden\\HP1.txt""")
tm.make_sentence_lengths()
tm.make_words()
tm.make_word_lengths()
tm.make_stems()
tm.make_relative_pronouns()
