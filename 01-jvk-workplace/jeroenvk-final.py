...
class TextModel:
    ...
    def __init__(self):
        ...
        self.possessives = {}       # Om possessives te tellen -> de dict van modals met counts
    ...
    def compare_text_with_two_models(self, model1, model2):
        ...
        ### Possessives ###
        possessives_score = self.compare_dictionaries(self.possessives, model1.possessives, model2.possessives)
        if possessives_score[0] > possessives_score[1]:
            score_tm1 += 1
